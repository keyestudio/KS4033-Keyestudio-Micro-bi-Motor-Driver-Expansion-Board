# KS4033 Keyestudio Micro:bi Motor Driver Expansion Board
...
Wire up, upload the code and power on. Two motors rotate clockwise for 2s and anticlockwise for 2s.
